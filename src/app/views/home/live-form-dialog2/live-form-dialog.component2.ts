...
@Component({
  ...
  templateUrl: './live-form-dialog.component2.html',
  styleUrls: ['./live-form-dialog.component2.css']
})
export class LiveFormDialogComponent2 implements OnInit {
  public liveForm: FormGroup;

  constructor(
    public dialogRef: MatDialogRef<LiveFormDialogComponent2>,
